const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://www.heshixue.top' },
    { title: '访问文档中心获取更多帮助', url: 'https://www.heshixue.top' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '分享攻略',
  HEO_HERO_TITLE_2: '与思维认知',
  HEO_HERO_TITLE_3: 'HESHIXUE.TOP',
  HEO_HERO_TITLE_4: '新版上线',
  HEO_HERO_TITLE_5: '轻松汇款与投资',
  HEO_HERO_TITLE_LINK: 'https://www.heshixue.top',
  // 英雄区遮罩文字
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/heshixue9',
  HEO_INFO_CARD_ICON2: 'fab fa-github',
  HEO_INFO_CARD_URL3: 'https://www.heshixue.top',
  ...
  HEO_SOCIAL_CARD_URL: 'https://t.me/+zWiAqci4TAdlNGE1',
